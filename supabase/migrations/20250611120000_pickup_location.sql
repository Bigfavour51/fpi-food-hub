...
-- Create the function with pickup location
...
-- Enable RPC
ALTER FUNCTION create_order_with_items(text, decimal, text, jsonb, text, text) SET search_path = public;

-- Update the test function to include pickup location
DROP FUNCTION IF EXISTS test_create_order;
